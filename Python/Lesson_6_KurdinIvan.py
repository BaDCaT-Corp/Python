...
class TrafficLight:
    ...
    def running(self):
        for color, sec in cycle(self.__color):
            print(color, '(running {} sec)'.format(sec))
            sleep(sec)
...
sport_car = SportCar(240, 'Write', 'Mercedes GLC', False)
town_car = TownCar(140, 'Black', 'BMW Q5', False)
work_car = WorkCar(90, 'Yellow', 'Skoda', False)
police_car = PoliceCar(210, 'Blue', 'Lada', True)
...
class Stationery:
    ...
    def draw(self):
        print('Запуск отрисовки default.')
